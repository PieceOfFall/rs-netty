...
use crate::{
    ...
    pipeline::pipe::{BusinessPipe, InboundPipe, OutboundPipe},
    traits::{Flow, Handler},
    Result,
};

pub struct Pipeline<C, InP, BizP, H, OutP, CurrentIn, Write, CurrentOut> {
    codec: C,
    inbound: InP,
    business: BizP,
    handler: H,
...
impl<C, InP, BizP, H, OutP, CurrentIn, Write, CurrentOut>
    Pipeline<C, InP, BizP, H, OutP, CurrentIn, Write, CurrentOut>
{
...
pub trait RuntimePipeline: Send + 'static {
...
impl<C, InP, BizP, H, OutP, CurrentIn, Write, CurrentOut> RuntimePipeline
    for Pipeline<C, InP, BizP, H, OutP, CurrentIn, Write, CurrentOut>
where
